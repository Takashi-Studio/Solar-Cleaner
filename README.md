...
[![PostgreSQL](https://img.shields.io/badge/Database-PostgreSQL%20%7C%20Prisma-336791?style=for-the-badge&logo=postgresql)](https://www.postgresql.org/)
...
graph TD
    ...
    classDef server fill:#1e293b,stroke:#a855f7,stroke-width:2px,color:#fff;
    classDef db fill:#022c22,stroke:#10b981,stroke-width:2px,color:#fff;
    classDef broker fill:#1c1917,stroke:#f59e0b,stroke-width:2px,color:#fff;
    classDef hw fill:#172554,stroke:#3b82f6,stroke-width:2px,color:#fff;

    subgraph Cloud_SaaS [Cloud SaaS Infrastructure]
        A["💻 React Frontend Dashboard"]:::web
        B["⚙️ Node.js Backend Server"]:::server
        C["🗄️ PostgreSQL Database"]:::db
    end

    subgraph Communication_Layer [Real-Time Messaging]
        D["📡 Mosquitto MQTT Broker"]:::broker
    end

    subgraph Edge_Hardware [Edge IoT Hardware]
        E["📶 ESP-01 WiFi Module"]:::hw
        F["🧠 Arduino Mega 2560"]:::hw
        G["🔌 Actuators & Sensors"]:::hw
    end
